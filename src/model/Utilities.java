...
public class Utilities {
	...
	/**
	 * Writes the provide string to the file. Displays a message indicating the
	...
	public static String indent(int indentation, int numTabs) {
		String returnText = "";
		for (int i = 0; i < indentation * numTabs; i++) {
			returnText += " ";
		}
		return returnText;
	}

	public static String getListTagName(boolean ordered) {
		if (ordered) {
			return "ol";
		} else {
			return "ul";
